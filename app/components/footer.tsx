...
export default function Footer() {
  return (
    <footer className=" bg-gradient-to-r from-indigo-600 to-purple-600 text-white py-12 rounded-t-3xl shadow-lg">
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <div className="flex space-x-6">
            <motion.a 
              href="https://www.linkedin.com/in/abiboulaye-sy-88511a293?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=ios_app" 
              target="_blank" 
